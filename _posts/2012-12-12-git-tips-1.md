...
Je vais ici vous présenter quelques idées qui me semblent importants sur la manière d'utiliser Git. Je ne me veux pas exhaustif ici, je veux surtout revenir sur des petits points très spécifiques qui — d'après ce que j'ai pu voir — posent problème à beaucoup.

{% assign current = "part1" %}
...
Rendez-vous maintenant à la deuxième partie : {% if currentDate >= "2012-12-14" %}[Oubliez SVN](/article/2012-12-14/git-tips-2){% else %}Oubliez SVN{% endif %}.
